...
const Overview = () => {
    ...
    return (
        <div className='mt-6 grid grid-cols-3 gap-6'>
            <div className='col-span-2 shadow_x h-[20rem] rounded-xl bg-white  px-5 py-4'>
                ...
                <div className='flex items-end h-[75%] justify-between mt-3'>
                    {
                        month.map((i, index) => {
                            return <div key={index}>
                                <p className={` rounded-t-md  w-[2.6rem] `} style={{ background: i.bg, height: i.earning }} ></p>
            ...
            <div className='col-span-1 shadow_x h-[20rem] rounded-xl bg-white px-5 py-4 max-[340px]:none'>
